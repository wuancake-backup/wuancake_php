...
class Smarty_Internal_Runtime_CodeFrame
{
                           ...
                           Smarty_Internal_TemplateCompilerBase $compiler = null)
    {
        ...
        $dec = "\$_smarty_tpl->MVC->ext->_validateCompiled->decodeProperties(\$_smarty_tpl, " .
        ...
        if (!$cache) {
            ...
            if ($_template->caching && !empty($_template->compiled->required_plugins[ 'nocache' ])) {
                ...
                $output .= "echo '/*%%SmartyNocache:{$_template->compiled->nocache_hash}%%*/<?php \$_smarty = \$_smarty_tpl->MVC; ";
