...
class Smarty_Security
{
    ...
    /**
     * This is an array of disabled special $MVC variables.
     *
     * @var array
     */
    ...
    /**
     * Check if special $MVC variable is trusted.
     *
    ...
    public function isTrustedSpecialSmartyVar($var_name, $compiler)
    {
        if (!in_array($var_name, $this->disabled_special_smarty_vars)) {
            ...
            $compiler->trigger_template_error("special variable '\$MVC.{$var_name}' not allowed by security setting", null, true);
        }
