...
abstract class Smarty_Internal_TemplateCompilerBase
{
    ...
    private function compileTag2($tag, $args, $parameter)
    {
        ...
        // compile the MVC tag (required compile classes to compile the tag are auto loaded)
    ...
    public function compileConfigVariable($variable)
    {
        ...
        return '$_smarty_tpl->MVC->ext->configLoad->_getConfigVariable($_smarty_tpl, ' . $variable . ')';
    }
