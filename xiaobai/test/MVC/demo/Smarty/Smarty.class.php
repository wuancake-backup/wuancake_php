 ...
 * MVC-discussion-subscribe@googlegroups.com
 *
 * @link      http://www.MVC.net/
 ...
 * @method int compileAllTemplates(Smarty $MVC, string $extension = '.tpl', bool $force_compile = false, int $time_limit = 0, int $max_errors = null)
 * @method int compileAllConfig(Smarty $MVC, string $extension = '.conf', bool $force_compile = false, int $time_limit = 0, int $max_errors = null)
 *
 */
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    /**
     * When set, MVC uses this value as error_reporting-level.
     *
     * @var int
     */
    ...
    public static function mutingErrorHandler($errno, $errstr, $errfile, $errline, $errcontext)
    {
        ...
        // or the error was within MVC but masked to be ignored
