...
class Smarty_Internal_Compile_Private_ForeachSection extends Smarty_Internal_CompileBase
{
    ...
    /**
     * Valid properties of $MVC.xxx variable
     *
     * @var array
     */
    ...
    public function buildPropertyPreg($named, $attributes)
    {
        if ($named) {
            ...
            $this->propertyPreg .= "([\$]MVC[.]{$this->tagName}[.]{$attributes['name']}[.](";
    ...
    /**
     * Compiles code for the {$MVC.foreach.xxx} or {$MVC.section.xxx}tag
     *
    ...
    public function compileSpecialVariable($args, Smarty_Internal_TemplateCompilerBase $compiler, $parameter)
    {
        ...
        if (!$property || !in_array($property, $this->nameProperties)) {
            $compiler->trigger_template_error("missing or illegal \$MVC.{$tag} property attribute", null, true);
        }
