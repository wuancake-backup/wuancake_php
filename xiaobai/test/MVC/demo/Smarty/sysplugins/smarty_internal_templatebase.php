...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data
{
     ...
     *
     * @api  Smarty::isCached()
     * @link http://www.MVC.net/docs/en/api.is.cached.tpl
     *
     ...
     * @link http://www.MVC.net/docs/en/api.register.plugin.tpl
     *
     ...
     * @link http://www.MVC.net/docs/en/api.load.filter.tpl
     *
     ...
     * @link http://www.MVC.net/docs/en/api.register.filter.tpl
     *
     * @param  string      $type filter type
     ...
     * @link http://www.MVC.net/docs/en/api.register.object.tpl
     *
     * @param  string $object_name
     * @param  object $object                     the referenced PHP object to register
     * @param  array  $allowed_methods_properties list of allowed methods (empty = all)
     * @param  bool   $format                     MVC argument format, else traditional
