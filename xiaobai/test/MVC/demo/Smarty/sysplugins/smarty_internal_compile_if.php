        ...
        if (is_array($parameter['if condition'])) {
            ...
            if (is_array($parameter['if condition']['var'])) {
                $_output = "<?php if (!isset(\$_smarty_tpl->tpl_vars[" . $parameter['if condition']['var']['var'] .
                    ...
                    "]->value)) \$_smarty_tpl->MVC->ext->_var->createLocalArrayVariable(\$_smarty_tpl, " . $parameter['if condition']['var']['var'] .
                    "$_nocache);\n";
            ...
            if ($condition_by_assign) {
                ...
                if (is_array($parameter['if condition']['var'])) {
                    $_output = "<?php } else { if (!isset(\$_smarty_tpl->tpl_vars[" .
                        ...
                        "]->value)) \$_smarty_tpl->MVC->ext->_var->createLocalArrayVariable(\$_smarty_tpl, " .
