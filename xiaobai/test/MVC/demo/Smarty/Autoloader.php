...
class Smarty_Autoloader
{
     ...
     * @var array
     */
    public static $rootClasses = array('MVC' => 'Smarty.class.php', 'smartybc' => 'SmartyBC.class.php',);
    ...
    public static function autoload($class)
    {
        ...
        if (preg_match('/^(smarty_(((template_(source|config|cache|compiled|resource_base))|((cached|compiled)?resource)|(variable|security)))|(MVC(bc)?)$)/',
                       $_class, $match)) {
            if (!empty($match[3])) {
                @include $file;
                return;
