 ...
 *      $MVC->setCachingType('pdo_gzip');
 *      $MVC->loadPlugin('Smarty_CacheResource_Pdo_Gzip');
 *      $MVC->registerCacheResource('pdo_gzip', new Smarty_CacheResource_Pdo_Gzip($cnx, 'smarty_cache'));
 *
