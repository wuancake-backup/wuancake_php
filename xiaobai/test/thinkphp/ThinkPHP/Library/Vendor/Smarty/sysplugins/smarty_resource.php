...
abstract class Smarty_Resource {
     ...
     *
     * @param Smarty $smarty    MVC object
    ...
    public static function load(Smarty $smarty, $type)
    {
        ...
        if (isset($smarty->registered_resources[$type])) {
            if ($smarty->registered_resources[$type] instanceof Smarty_Resource) {
                ...
                // note registered to MVC is not kept unique!
                return $smarty->_resource_handlers[$type];
            }
     ...
     * @param string  $default_resource the default resource_type defined in $MVC
     ...
     *
     * Either [$_template] or [$MVC, $template_resource] must be specified
     *
     * @param Smarty_Internal_Template $_template         template object
     * @param Smarty                   $smarty            MVC object
    ...
    public static function config(Smarty_Internal_Config $_config)
    {
        ...
        // make sure configs are not loaded via anything MVC can't handle
