...
class Smarty_Internal_Compile_Private_Special_Variable extends Smarty_Internal_CompileBase {
    ...
    /**
     * Compiles code for the speical $MVC variables
     *
    ...
    public function compile($args, $compiler, $parameter)
    {
        ...
        switch ($variable) {
            case 'foreach':
                return "\$_smarty_tpl->getVariable('MVC')->value$parameter";
            case 'section':
                return "\$_smarty_tpl->getVariable('MVC')->value$parameter";
            case 'capture':
            ...
            default:
                $compiler->trigger_template_error('$MVC.' . trim($_index[0], "'") . ' is invalid');
                break;
        }
        if (isset($_index[1])) {
            array_shift($_index);
