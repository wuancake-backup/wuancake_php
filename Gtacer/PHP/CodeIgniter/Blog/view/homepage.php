...
<div>
    ...
    <div class="all_right">
        ...
        <?php foreach ($title as $key=>$value){?>
            <div class="right">
                <div class="title">
                    <span class="article_title"><strong><?php echo $value; ?></strong></span>    <!--标题-->
                ...
                <div>
                    <div class="read_all"><a href="http://localhost/codeigniter/index.php/blog/show_content/<?php echo $key+1;  ?>">阅读本文</a></div>
                    <hr />
                </div>
            </div>
        <?php } ?>
