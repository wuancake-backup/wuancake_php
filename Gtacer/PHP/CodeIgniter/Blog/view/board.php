<div class="board">
    <div class="board_1">
        ...
        <table  border='1' cellspacing="0" cellpadding="20" >
            <tr>
                <td class="board_2">用户昵称：<br/><?php echo htmlentities($value); ?><br/>
    ...
    <div style="text-align: center;color: aqua">
        ...
        <form action="http://localhost/CodeIgniter/index.php/blog/give_message" method="post">
            ...
            <textarea rows="10" cols="122" name="message">Hello world!</textarea>
                                                                                <br/><br/>
            留言ID:<input type="text" name="username">
            <input type="submit" value="提交留言" class="commend_1"/>
