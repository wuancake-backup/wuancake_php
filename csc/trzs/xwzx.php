...
<div class="newsbox yh">
    	<div class="block">
            ...
            <div class="text-list yh">
				<ul>
					<?php include './php/xwzx.php';
						while($row = mysql_fetch_array($result)){
					?>
	
                    <li class="clearfix">
						<div class="fleft"><img src="images/1.jpg" width="200" height="150"></div>
						<div class="fright">
							<p class="bt"><a href="xwnr.php?id=<?=$row['id']?>"><?=$row['title']?></a></p>
							<p class="jj"><?php echo substr($row['content'],0,140);?>...</p>
                            <p class="ck"><span class="eye"><?=$row['eye']?></span><span class="time"><?$time = date('Y-m-d H:i:s',$row['time']);echo $time;?></span></p>
						</div>
					</li>
					<?php }?>
				</ul>
