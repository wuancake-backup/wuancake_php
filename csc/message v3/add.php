<META http-equiv="content-type" content="text/html; charset=utf-8"><title>添加新留言</title>
...
if(addForm.content.value.length<15){ 
alert("内容不能少于15个字符"); 
...
标题：<INPUT TYPE="text" NAME="title" placeholder="(必填，不得少于5位)"/><br /> 
内容：<TEXTAREA NAME="content" placeholder="(必填，不得少于15位)" ROWS="8" COLS="30"></TEXTAREA><br /> 
